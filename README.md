...
By forcing app updates through disabling the API credentials of older app versions, Crunchyroll has made it impossible to watch on devices running iOS 12 and above. This tweak allows you to use credentials of newer versions to make the app work again.
...
"""
> *Note* : This still needs to be compiled and tested on iOS 12.x
